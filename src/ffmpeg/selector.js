...
// export function pickRandomPresets(variationCount) {
//   if (variationCount > PRESETS.length) {
//     throw new Error(
//       `Requested ${variationCount} variations but only ${PRESETS.length} presets exist`,
//     );
//   }
