...
export const getLutPath = (fileName) => {
  const fullPath = app.isPackaged
    ? path.join(process.resourcesPath, "luts", "sample", fileName)
    : path.join(app.getAppPath(), "src", "luts", "sample", fileName);
...
const getGradientPath = () => {
  const fullPath = app.isPackaged
    ? path.join(process.resourcesPath, "assets", "gradient-4.png")
    : path.join(app.getAppPath(), "src", "assets", "gradient-4.png");
...
export const generatePresetsSet8 = (startId) => {
